...
\end{align*}
\newpage
Moreover, the $y_j^*$ are unbounded with respect to the $\| \cdot \|_{X^*}$ norm. Indeed,
\begin{align*}
\| y_j^* \|_{X^*} = \sup_{\substack{x \in C_0(\mathbb{K})\\ \|x\|_\infty \leq 1}} | y_j^*(x)| \leq \sup_{\substack{x \in C_0(\mathbb{K})\\ \|x\|_\infty \leq 1}} \frac{1}{j} \sum_{k=1}^{j^2}|x_k| \leq \sup_{\substack{x \in C_0(\mathbb{K})\\ \|x\|_\infty \leq 1}}  j \|x\|_\infty = j 
\end{align*}
